...
{    
       ...
       )
    {
        ...
        //tsiHostInterface_packet.data[0] = alertOut_type_buttonPress;
        //tsiHostInterface_packet.data[1] = tsiHostInterface_packet.type;
        //tsiHostInterface_packet.type = packetType_alertOut;
        //HostInterface_RxQueueMsgPut((hostInterface_packet_t *)&tsiHostInterface_packet);
    }
